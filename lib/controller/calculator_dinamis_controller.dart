...
class CalculatorDinamisController extends GetxController {
  ...
  void addWidgetCheckBox() {
    buildCheckBoxes().add(buildCheckBox());
  }

  void removeWidgetCheckBox() {
    buildCheckBoxes().removeLast();
  }
